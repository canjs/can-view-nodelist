# Contributing to can-view-nodelist
...
This section will walk you through setting up the [repository](https://github.com/canjs/can-view-nodelist) on your computer.
...
GitHub has a guide for [forking a repo](https://help.github.com/articles/fork-a-repo/). To fork can-view-nodelist, you can start by going to its [fork page](https://github.com/canjs/can-view-nodelist/fork).
...
```shell
git clone https://github.com/YOUR-USERNAME/can-view-nodelist
```
